VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ListViewReport 
   Caption         =   "ListView Report"
   ClientHeight    =   11595
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   19080
   Icon            =   "Report (2).dsx":0000
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "ListView Report"
         Alignment       =   2
      EndProperty
      ItemType2       =   5
   ...
   EndProperty
End
Attribute VB_Name = "ListViewReport"
